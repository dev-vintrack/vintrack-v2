...
@section('title', 'Verificar correo - VINTRACK')

@section('content')
    <h3 class="text-center mb-3">Verificar correo</h3>
    <p class="text-center text-white-50">Ingresa el código que recibiste.</p>
